/*
  # Fix RLS policies and user roles system

  1. Security Updates
    - Update user_roles table constraints
    - Create utility functions for role checking
    - Fix all RLS policies to avoid conflicts
...
DROP POLICY IF EXISTS "Admin and authenticated full access to patients" ON patients;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to treatments" ON treatments;
DROP POLICY IF EXISTS "Anonymous can view treatments" ON treatments;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to appointments" ON appointments;
DROP POLICY IF EXISTS "Anonymous can view appointments" ON appointments;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to products" ON products;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to appareils" ON appareils;
DROP POLICY IF EXISTS "Anonymous can view appareils" ON appareils;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to zones" ON zones;
DROP POLICY IF EXISTS "Anonymous can view zones" ON zones;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to soins" ON soins;
DROP POLICY IF EXISTS "Anonymous can view soins" ON soins;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to forfaits" ON forfaits;
DROP POLICY IF EXISTS "Anonymous can view forfaits" ON forfaits;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to consumption reports" ON consumption_reports;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to stock alerts" ON stock_alerts;
...
DROP POLICY IF EXISTS "Admin and authenticated full access to cost analysis" ON cost_analysis;
...
DROP POLICY IF EXISTS "Admin full access to user roles" ON user_roles;
DROP POLICY IF EXISTS "Users can view and manage their own role" ON user_roles;

-- Create NEW policies

-- Patients policies
CREATE POLICY "Authenticated full access to patients" ON patients
...
-- Treatments policies
CREATE POLICY "Authenticated full access to treatments" ON treatments
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view treatments" ON treatments
  FOR SELECT TO anon
  USING (true);

-- Appointments policies
CREATE POLICY "Authenticated full access to appointments" ON appointments
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view appointments" ON appointments
  FOR SELECT TO anon
  USING (true);
...
-- Appareils policies
CREATE POLICY "Authenticated full access to appareils" ON appareils
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view appareils" ON appareils
  FOR SELECT TO anon
  USING (true);

-- Zones policies
CREATE POLICY "Authenticated full access to zones" ON zones
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view zones" ON zones
  FOR SELECT TO anon
  USING (true);

-- Soins policies
CREATE POLICY "Authenticated full access to soins" ON soins
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view soins" ON soins
  FOR SELECT TO anon
  USING (true);

-- Forfaits policies
CREATE POLICY "Authenticated full access to forfaits" ON forfaits
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon can view forfaits" ON forfaits
  FOR SELECT TO anon
  USING (true);

-- Consumption reports policies
CREATE POLICY "Authenticated full access to consumption reports" ON consumption_reports
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

-- Stock alerts policies
CREATE POLICY "Authenticated full access to stock alerts" ON stock_alerts
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);

-- Cost analysis policies
CREATE POLICY "Authenticated full access to cost analysis" ON cost_analysis
  FOR ALL TO authenticated
  USING (true)
  WITH CHECK (true);
